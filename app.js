...
function move(){    
    mousePosition_relative_lerped.x = lerp (mousePosition_relative_lerped.x, mousePosition_relative.x, 0.1);
    mousePosition_relative_lerped.y = lerp (mousePosition_relative_lerped.y, mousePosition_relative.y, 0.1);
    mousePosition_relative_lerped.z = lerp (mousePosition_relative_lerped.z, mousePosition_relative.z, 0.1);
    const x = mousePosition_relative_lerped.x * 15;
